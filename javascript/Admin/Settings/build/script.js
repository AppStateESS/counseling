...
var LineEdit = React.createClass({
    ...
    render: function render() {
        return React.createElement(
            ...
            React.createElement('input', { className: 'editItem form-control', placeholder: this.props.placeholder,
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    ...
                                    React.createElement('input', { type: 'radio', name: 'instruction', defaultValue: '1', defaultChecked: true, tabIndex: 3, onClick: this.updateInstruction }),
                                    ' Sit down'
                                ),
                                React.createElement(
                                    'label',
                                    null,
                                    React.createElement('input', { type: 'radio', name: 'instruction', defaultValue: '2', tabIndex: 4, onClick: this.updateInstruction }),
                                    ' Front desk'
                                )
                            )
                        ),
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    'label',
                    null,
                    React.createElement('input', { type: 'radio', name: 'summaryGroup', defaultValue: '1', onClick: this.updateCategory }),
                    ' ',
            ...
            React.createElement(
                ...
                React.createElement(
                    'label',
                    null,
                    React.createElement('input', { type: 'radio', name: 'summaryGroup', defaultValue: '2', onClick: this.updateCategory }),
                    ' ',
            ...
            React.createElement(
                ...
                React.createElement(
                    'label',
                    null,
                    React.createElement('input', { type: 'radio', name: 'summaryGroup', defaultChecked: true, defaultValue: '0', onClick: this.updateCategory }),
                    ' ',
